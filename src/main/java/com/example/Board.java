...
//        	white to black.
    ...
    void initializePieces() {
    	...
    	board[0][3].put(new Pawn(false, RESOURCES_BPAWN_PNG));
        board[7][6].put(new Pawn(true, RESOURCES_WPAWN_PNG));
         board[7][0].put(new Pawn(true, RESOURCES_WPAWN_PNG));
         board[8][0].put(new King(false, RESOURCES_WQUEEN_PNG));
    }
